...
<head>
    ...
    <link rel="stylesheet" href="../utils/css/paginaHistorial.css">
...
<body>
    <header class="bg-dark py-2">
        <div class="contenedor px-4 px-lg-5 my-5">
            ...
            if (!empty($compras)) {
                foreach ($compras as $compra) {
                    ...
                    foreach ($compra['productos'] as $producto) {
                        ...
                        echo '<h5 class="card-title">' . $producto['productoNombre'] . '</h5>';
                        echo '<p class="card-text">' . $producto['descripcion'] . '</p>';
                        echo '<p class="card-text"><small class="text-body-secondary">Precio: $' . $producto['productoPrecio'] . ' MXN</small></p>';
                        echo '</div>';
                        echo '</div>';
                    }
